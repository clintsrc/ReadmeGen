...
if (DEBUG) {
    defaultAnswers = [
        ...
        'See the walkthrough video [here](https://drive.google.com/file/d/1cJHOSW0YCQAJmIs3dNgBczkvHlMfWcpE/view?usp=drive_link)!  1. Build and run the application from the project root directory: npm start.  2. Follow the menu prompts.',
        'mit',
