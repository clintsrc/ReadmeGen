...
if (DEBUG) {
    defaultAnswers = [
        ...
        '1. Change the project\'s root directory  2. Install the dependency modules: npm install  3. Build: npm run build  ![Reshelve screenshot](Assets/images/screenshot.png)',
        '1. Start the server: npm run start:dev  2. See the ![spec](Assets/decs/spec.md) for details of the original requirements  3. Use a RESTful API tool to send HTTP requests. For examples you can import this ![Insomnia test](Assets/test/SNAPI-REST.ext) configuration  * See the [SNAPI Walkthrough video](https://drive.google.com/TBD)',
        'mit',
